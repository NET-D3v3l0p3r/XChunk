...
{
    public struct TileUpZ : ITile
    {
        public VertexPositionTexture[] Vertices { get; set; }

        public TileUpZ(Vector3 position, int x, int y, int z, Vector2 texCoord)
            : this()
        {
            ...
            Vertices[1] = new VertexPositionTexture(position + new Vector3(x, y, z + 1),   new Vector2(ChunkRenderer.TEXTURE_RATIO_X + texCoord.X, ChunkRenderer.TEXTURE_RATIO_Y + texCoord.Y));
            Vertices[2] = new VertexPositionTexture(position + new Vector3(x, y + 1, z + 1),   new Vector2(ChunkRenderer.TEXTURE_RATIO_X + texCoord.X, 0 + texCoord.Y));
